...
// import { setFilter, setCustomFilter } from '../store/launchReducer';
// import LaunchListItem from './LaunchListItem';
...
const LaunchList = () => {
  ...
  const handleCustomFilter = () => {
    dispatch(setCustomFilter({ startDate: customStartDate, endDate: customEndDate }));
  };
    ...
    <div className={styles.launchListContainer}>
      ...
      <div className={styles['filter-bar']}>
        <div className={styles['filter-buttons']}>
          <button onClick={() => handleFilterChange('all')}>All Launches</button>
          <button onClick={() => handleFilterChange('upcoming')}>Upcoming Launches</button>
          <button onClick={() => handleFilterChange('past')}>Past Launches</button>
        </div>
        <div className={styles['date-inputs']}>
          ...
          <button className={styles['apply-custom-filter-button']} onClick={handleCustomFilter}>Apply Custom Filter</button>
        </div>
      </div>
